...
declare class UploadCollection extends UI5Element {
    ...
    _ondragleave(): void;
    _onItemDelete(e: CustomEvent<UploadCollectionItemDeleteEventDetail>): void;
    _onSelectionChange(e: CustomEvent<UploadCollectionSelectionChangeEventDetail>): void;
    get classes(): {
        content: {
