...
function block0(context, tags, suffix) { return suffix ? html `<div class="ui5-switch-root ${classMap(this.classes.main)}" role="switch" aria-label="${ifDefined(this.ariaLabelText)}" aria-checked="${ifDefined(this.checked)}" aria-disabled="${ifDefined(this.effectiveAriaDisabled)}" @click="${this._onclick}" @keyup="${this._onkeyup}" @keydown="${this._onkeydown}" tabindex="${ifDefined(this.effectiveTabIndex)}" dir="${ifDefined(this.effectiveDir)}" title="${ifDefined(this.tooltip)}"><div class="ui5-switch-inner"><div class="ui5-switch-track" part="slider"><div class="ui5-switch-slider">${this.graphical ? block1.call(this, context, tags, suffix) : block2.call(this, context, tags, suffix)}<span class="ui5-switch-handle" part="handle"><${scopeTag("ui5-icon", tags, suffix)} name="${ifDefined(this.sapNextIcon)}" class="ui5-switch-handle-icon"></${scopeTag("ui5-icon", tags, suffix)}></span></div></div></div><input type='checkbox' ?checked="${this.checked}" class="ui5-switch-input" data-sap-no-tab-ref/></div>` : html `<div class="ui5-switch-root ${classMap(this.classes.main)}" role="switch" aria-label="${ifDefined(this.ariaLabelText)}" aria-checked="${ifDefined(this.checked)}" aria-disabled="${ifDefined(this.effectiveAriaDisabled)}" @click="${this._onclick}" @keyup="${this._onkeyup}" @keydown="${this._onkeydown}" tabindex="${ifDefined(this.effectiveTabIndex)}" dir="${ifDefined(this.effectiveDir)}" title="${ifDefined(this.tooltip)}"><div class="ui5-switch-inner"><div class="ui5-switch-track" part="slider"><div class="ui5-switch-slider">${this.graphical ? block1.call(this, context, tags, suffix) : block2.call(this, context, tags, suffix)}<span class="ui5-switch-handle" part="handle"><ui5-icon name="${ifDefined(this.sapNextIcon)}" class="ui5-switch-handle-icon"></ui5-icon></span></div></div></div><input type='checkbox' ?checked="${this.checked}" class="ui5-switch-input" data-sap-no-tab-ref/></div>`; }
